...
//**************************************************************************************************************
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                 {"name": "修改", "fn": "mod(\'" + "role!modrole.action" + "\',\'" + c.id + "\',\'" + "修改角色信息" + "\')", "type": "primary"},
                                 {"name": "删除", "fn": "del(\'" + "role!delrole.action" + "\',\'" + c.id + "\')", "type": "danger"}
                            ]
                        };
            ...
            initComplete: function () {
                $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'system/role/addrole.jsp\',\'添加角色\')">添加角色</button>');
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	...
	<a class="toggle-vis" data-column="1">角色名称</a>&nbsp;
	<a class="toggle-vis" data-column="2">角色模式</a>&nbsp;
	<a class="toggle-vis" data-column="3">操作</a>&nbsp;
	</div>
