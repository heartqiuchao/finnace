...
<body>
<form name="form1" id="form1" action="user!adduser.action"  target="frmright" method="post">
		<table class="tableStyle" transMode="true">
		<tr>
			<td>用户编号：</td>
			<td><input type="text" name="user.usercode"/>
			</td>
		</tr>
		<tr>
			<td>用户姓名：</td>
		...
		<tr>
			<td>用户年龄：</td><td><input type="text" id="user.userage" name="user.userage"/>
			</td>
		</tr>
		<tr>
			<td>身份证号：</td><td><input type="text" name="user.userkey"/>
			</td>
		</tr>
		<tr>
			<td>用户电话：</td><td><input type="text" id="user.usertel" name="user.usertel"/></td>
		</tr>
		<tr>
			<td>用户性别：</td>
		...
		<tr>
			<td>登陆账号：</td><td><input type="text" name="user.account"/>*</td>
		</tr>
		<tr>
