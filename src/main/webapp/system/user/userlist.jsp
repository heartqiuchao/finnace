...
//**************************************************************************************************************
            ...
            columnDefs: [
                {//列添加函数
                    ...
                    render: function (a, b, c, d) {
                        ...
                        {
                            func: [
                                 {"name": "修改", "fn": "mod(\'" + "user!finduser.action" + "\',\'" + c.userid + "\',\'" + "修改用户信息" + "\')", "type": "primary"},
                                 {"name": "删除", "fn": "del(\'" + "user!deluser.action" + "\',\'" + c.userid + "\')", "type": "danger"}
                            ]
                        };
            ...
            initComplete: function () {
                $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'user!findrole.action\',\'添加用户\')">添加用户</button>');
                $("#mytool").append('<button type="button" class="btn btn-default btn-sm" onclick="add(\'catchinfo!startCatch.action\',\'更新数据库\')">更新数据库</button>');
...
<div class="container" style="position: relative;  height:95%; width:100%;">
	...
	<a class="toggle-vis" data-column="1">用户编号</a>&nbsp;
	<a class="toggle-vis" data-column="2">用户名称</a>&nbsp;
	<a class="toggle-vis" data-column="3">用户帐号</a>&nbsp;
	<a class="toggle-vis" data-column="4">年龄</a>&nbsp;
	<a class="toggle-vis" data-column="5">性别</a>&nbsp;
	<a class="toggle-vis" data-column="6">身份证号</a>&nbsp;
	<a class="toggle-vis" data-column="7">电话号</a>&nbsp;
	<a class="toggle-vis" data-column="8">角色</a>&nbsp;
	<a class="toggle-vis" data-column="9">操作</a>&nbsp;
	</div>
